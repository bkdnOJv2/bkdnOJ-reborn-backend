    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problems', models.ManyToManyField(related_name='judges', to='problem.problem', verbose_name='problems')),
            ],
            options={
                'verbose_name': 'judge',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('judge', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='runtime.judge', verbose_name='judge on which this runtime exists')),
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='runtime.language', verbose_name='language to which this runtime belongs')),
            ],
        ),
        migrations.AddField(
            model_name='judge',
            name='runtimes',
            field=models.ManyToManyField(related_name='judges', to='runtime.language', verbose_name='judges'),
        ),
    ]
