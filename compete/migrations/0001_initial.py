    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(max_length=20, unique=True, validators=[django.core.validators.RegexValidator('^[a-z][a-z0-9]+$', 'Contest identifier must starts with a letter, contains only letters.'), django.core.validators.MinLengthValidator(4)], verbose_name='contest identifier')),
                ...
                ('use_clarifications', models.BooleanField(default=True, help_text='Allow participants to use the clarification system.', verbose_name='Allow clarification request')),
