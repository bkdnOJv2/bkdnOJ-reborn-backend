"""
    URLs for auth module
"""

from auth.views import ActOnUsersView, RegisterView
...
urlpatterns = [
    ...
    path('user/<str:username>/reset-password/',
         reset_password, name='user-detail-reset-password'),
