    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(default=None, null=True, verbose_name='judge start time')),
                ('ping', models.FloatField(default=None, null=True, verbose_name='response time')),
                ('load', models.FloatField(default=None, help_text='Load for the last minute, divided by processors to be fair.', null=True, verbose_name='system load')),
